...
def upload_scan(
    ...
    try:
        ...
        project = project_repo.get_by_name(user.organization_id, project_id)

    if project is None:
        raise HTTPException(404, "Project not found")
    require_project_permission(db, user, project, "scans.upload", "scans.manage")
...
def delete_scan(
    ...
    require_project_permission(db, user, project, "scans.manage")
